...
if [ -f /root/.my.cnf ]; then
    ...
    mysql -e "CREATE OR REPLACE DATABASE ${DBNAME} /*\!40100 DEFAULT CHARACTER SET utf8 */;"
...
# If /root/.my.cnf doesn't exist then it'll ask for root password
    ...
    mysql -uroot -p${rootpasswd} -e "CREATE OR REPLACE DATABASE ${DBNAME} /*\!40100 DEFAULT CHARACTER SET utf8 */;"
